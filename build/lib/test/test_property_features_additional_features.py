...
from swagger_client.models.property_features_additional_features import PropertyFeaturesAdditionalFeatures


class TestPropertyFeaturesAdditionalFeatures(unittest.TestCase):
    """ PropertyFeaturesAdditionalFeatures unit test stubs """
    ...
    def testPropertyFeaturesAdditionalFeatures(self):
        """
        Test PropertyFeaturesAdditionalFeatures
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_additional_features.PropertyFeaturesAdditionalFeatures()
        pass
