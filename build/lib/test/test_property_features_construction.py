...
from swagger_client.models.property_features_construction import PropertyFeaturesConstruction


class TestPropertyFeaturesConstruction(unittest.TestCase):
    """ PropertyFeaturesConstruction unit test stubs """
    ...
    def testPropertyFeaturesConstruction(self):
        """
        Test PropertyFeaturesConstruction
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_construction.PropertyFeaturesConstruction()
        pass
