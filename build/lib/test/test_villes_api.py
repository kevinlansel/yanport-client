...
from swagger_client.apis.villes_api import VillesApi


class TestVillesApi(unittest.TestCase):
    """ VillesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.villes_api.VillesApi()
    ...
    def test_cities_id_get(self):
        """
        Test case for cities_id_get

        Récupérer une ville (ID)
        """
        pass

    def test_cities_ids_get(self):
        """
        Test case for cities_ids_get
