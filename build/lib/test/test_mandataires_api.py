...
from swagger_client.apis.mandataires_api import MandatairesApi


class TestMandatairesApi(unittest.TestCase):
    """ MandatairesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.mandataires_api.MandatairesApi()

    def tearDown(self):
        pass

    def test_mandatary_networks_get(self):
        """
        Test case for mandatary_networks_get

        Rechercher des réseaux mandataires
        """
        pass

    def test_mandatary_networks_id_get(self):
        """
        Test case for mandatary_networks_id_get
