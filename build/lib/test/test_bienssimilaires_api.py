...
from swagger_client.apis.bienssimilaires_api import BienssimilairesApi


class TestBienssimilairesApi(unittest.TestCase):
    """ BienssimilairesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.bienssimilaires_api.BienssimilairesApi()

    def tearDown(self):
        pass

    def test_similar_properties_get(self):
        """
        Test case for similar_properties_get

        Récuperer des biens similaires
        """
        pass

    def test_similar_properties_percentiles_get(self):
        """
        Test case for similar_properties_percentiles_get

        Indicateurs de références
        """
        pass

    def test_similar_properties_query_get(self):
        """
        Test case for similar_properties_query_get
