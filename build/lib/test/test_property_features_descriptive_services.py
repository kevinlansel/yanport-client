...
from swagger_client.models.property_features_descriptive_services import PropertyFeaturesDescriptiveServices


class TestPropertyFeaturesDescriptiveServices(unittest.TestCase):
    """ PropertyFeaturesDescriptiveServices unit test stubs """
    ...
    def testPropertyFeaturesDescriptiveServices(self):
        """
        Test PropertyFeaturesDescriptiveServices
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_descriptive_services.PropertyFeaturesDescriptiveServices()
        pass
