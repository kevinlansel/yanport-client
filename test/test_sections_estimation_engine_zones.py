...
from swagger_client.models.sections_estimation_engine_zones import SectionsEstimationEngineZones


class TestSectionsEstimationEngineZones(unittest.TestCase):
    """ SectionsEstimationEngineZones unit test stubs """
    ...
    def testSectionsEstimationEngineZones(self):
        """
        Test SectionsEstimationEngineZones
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.sections_estimation_engine_zones.SectionsEstimationEngineZones()
        pass
