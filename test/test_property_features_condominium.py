...
from swagger_client.models.property_features_condominium import PropertyFeaturesCondominium


class TestPropertyFeaturesCondominium(unittest.TestCase):
    """ PropertyFeaturesCondominium unit test stubs """
    ...
    def testPropertyFeaturesCondominium(self):
        """
        Test PropertyFeaturesCondominium
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_condominium.PropertyFeaturesCondominium()
        pass
