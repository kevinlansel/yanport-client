...
from swagger_client.models.property_features_geometry_areas import PropertyFeaturesGeometryAreas


class TestPropertyFeaturesGeometryAreas(unittest.TestCase):
    """ PropertyFeaturesGeometryAreas unit test stubs """
    ...
    def testPropertyFeaturesGeometryAreas(self):
        """
        Test PropertyFeaturesGeometryAreas
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_geometry_areas.PropertyFeaturesGeometryAreas()
        pass
