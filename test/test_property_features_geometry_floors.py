...
from swagger_client.models.property_features_geometry_floors import PropertyFeaturesGeometryFloors


class TestPropertyFeaturesGeometryFloors(unittest.TestCase):
    """ PropertyFeaturesGeometryFloors unit test stubs """
    ...
    def testPropertyFeaturesGeometryFloors(self):
        """
        Test PropertyFeaturesGeometryFloors
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_geometry_floors.PropertyFeaturesGeometryFloors()
        pass
