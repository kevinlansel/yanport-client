...
from swagger_client.models.user_user_preference_commercial_zone import UserUserPreferenceCommercialZone


class TestUserUserPreferenceCommercialZone(unittest.TestCase):
    """ UserUserPreferenceCommercialZone unit test stubs """
    ...
    def testUserUserPreferenceCommercialZone(self):
        """
        Test UserUserPreferenceCommercialZone
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.user_user_preference_commercial_zone.UserUserPreferenceCommercialZone()
        pass
