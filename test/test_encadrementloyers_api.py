...
from swagger_client.apis.encadrementloyers_api import EncadrementloyersApi


class TestEncadrementloyersApi(unittest.TestCase):
    """ EncadrementloyersApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.encadrementloyers_api.EncadrementloyersApi()

    def tearDown(self):
        pass

    def test_rent_control_check_post(self):
        """
        Test case for rent_control_check_post
