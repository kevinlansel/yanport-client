...
from swagger_client.models.property_features_descriptive import PropertyFeaturesDescriptive


class TestPropertyFeaturesDescriptive(unittest.TestCase):
    """ PropertyFeaturesDescriptive unit test stubs """
    ...
    def testPropertyFeaturesDescriptive(self):
        """
        Test PropertyFeaturesDescriptive
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_descriptive.PropertyFeaturesDescriptive()
        pass
