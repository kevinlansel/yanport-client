...
from swagger_client.apis.annonces_api import AnnoncesApi


class TestAnnoncesApi(unittest.TestCase):
    """ AnnoncesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.annonces_api.AnnoncesApi()
    ...
    def test_ads_id_get(self):
        """
        Test case for ads_id_get

        Récupérer une annonce (ID)
        """
        pass

    def test_ads_ids_get(self):
        """
        Test case for ads_ids_get

        Récupérer des annonces (ID)
        """
        pass

    def test_ads_urls_get(self):
        """
        Test case for ads_urls_get
