...
from swagger_client.models.property_features_descriptive_equipments import PropertyFeaturesDescriptiveEquipments


class TestPropertyFeaturesDescriptiveEquipments(unittest.TestCase):
    """ PropertyFeaturesDescriptiveEquipments unit test stubs """
    ...
    def testPropertyFeaturesDescriptiveEquipments(self):
        """
        Test PropertyFeaturesDescriptiveEquipments
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.property_features_descriptive_equipments.PropertyFeaturesDescriptiveEquipments()
        pass
