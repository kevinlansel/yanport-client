...
from swagger_client.apis.evenementsadbox_api import EvenementsadboxApi


class TestEvenementsadboxApi(unittest.TestCase):
    """ EvenementsadboxApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.evenementsadbox_api.EvenementsadboxApi()

    def tearDown(self):
        pass

    def test_adbox_events_count_group_by_group_by_and_sub_group_by_get(self):
        """
        Test case for adbox_events_count_group_by_group_by_and_sub_group_by_get

        Nombre de biens
        """
        pass

    def test_adbox_events_count_group_by_group_by_get(self):
        """
        Test case for adbox_events_count_group_by_group_by_get
