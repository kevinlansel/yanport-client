...
from swagger_client.apis.agences_api import AgencesApi


class TestAgencesApi(unittest.TestCase):
    """ AgencesApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.agences_api.AgencesApi()
    ...
    def test_agencies_get(self):
        """
        Test case for agencies_get

        Rechercher des agences
        """
        pass

    def test_agencies_id_get(self):
        """
        Test case for agencies_id_get
