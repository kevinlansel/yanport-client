...
from swagger_client.models.sections_property_price_study import SectionsPropertyPriceStudy


class TestSectionsPropertyPriceStudy(unittest.TestCase):
    """ SectionsPropertyPriceStudy unit test stubs """
    ...
    def testSectionsPropertyPriceStudy(self):
        """
        Test SectionsPropertyPriceStudy
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.sections_property_price_study.SectionsPropertyPriceStudy()
        pass
